...
def seed_data():
    ...
    for i in range(50):
        ...
        cursor.execute(
            "INSERT INTO users (phone, email, password, full_name, role, blood_type, humanitarian_points, reliability_score) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
            (phone, email, pwd, full_name, "DONOR", b_type, points, reliability)
        )
