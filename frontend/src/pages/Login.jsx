...
import { Droplets, Phone, ArrowRight, HeartHandshake, ShieldCheck, Mail, Lock } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100">
          <div className="p-8 pb-0 flex flex-col items-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Đăng nhập SBDCs</h1>
            <p className="text-gray-500 mt-2 text-center">
              Donor đăng nhập nhanh bằng số điện thoại. Hospital dùng tài khoản bảo mật.
            </p>
          </div>
          ...
          <div className="px-8 pt-6">
            <div className="grid grid-cols-2 rounded-2xl bg-gray-100 p-1">
              <button
                ...
                className={`rounded-xl py-3 text-sm font-black transition ${mode === 'DONOR' ? 'bg-white text-red-600 shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
              >
                Donor
              </button>
              <button
                ...
                className={`rounded-xl py-3 text-sm font-black transition ${mode === 'HOSPITAL_ADMIN' ? 'bg-white text-red-600 shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
              >
                Hospital
              </button>
            </div>
          ...
          <form onSubmit={handleLogin} className="p-8 space-y-5">
            {mode === 'DONOR' ? (
              ...
              <div className="bg-slate-50 text-slate-700 p-4 rounded-xl text-sm font-medium border border-slate-200 flex gap-2">
            ...
            {mode === 'DONOR' ? (
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-wider text-gray-400 ml-1">Số điện thoại Donor</label>
                ...
                <p className="text-[11px] text-gray-400 ml-1">Demo Donor: 0900000002 · Số mới sẽ tự tạo tài khoản Donor.</p>
              </div>
            ) : (
              <>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-gray-400 ml-1">Email hoặc số điện thoại Hospital</label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-gray-400 ml-1">Mật khẩu</label>
                  <div className="relative">
                  ...
                  <p className="text-[11px] text-gray-400 ml-1">Demo Hospital: hospital@sbdcs.com / Admin@123</p>
                </div>
              </>
            )}
          ...
          <div className="p-8 pt-0 text-center">
            <p className="text-gray-500 text-sm">Muốn nhập đầy đủ thông tin Donor? <Link to="/register" className="text-red-600 font-bold hover:underline underline-offset-4">Đăng ký hồ sơ</Link></p>
          </div>
        </div>
      </div>
    </div>
